...
const AnalyticsPage: React.FC = () => {
  ...
  const fetchDashboardData = async () => {
    try {
      ...
      setFinancialForecast(forecastResponse.data.results || forecastResponse.data)
                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between p-3 bg-blue-50 rounded-lg">
                    <div>
                      ...
                      <p className="text-xl font-bold text-blue-900">{formatCurrency(financialForecast.next_quarter)}</p>
                    </div>
                  ...
                  <div className="flex items-center justify-between p-3 bg-green-50 rounded-lg">
                    <div>
                      ...
                      <p className="text-xl font-bold text-green-900">{formatCurrency(financialForecast.ytd_revenue)}</p>
                    </div>
                  ...
                  <div className="flex items-center justify-between p-3 bg-purple-50 rounded-lg">
                    <div>
                      ...
                      <p className="text-xl font-bold text-purple-900">{formatCurrency(financialForecast.projected_annual)}</p>
                    </div>
                  ...
                  <div className="flex items-center justify-between p-3 bg-orange-50 rounded-lg">
                    <div>
                      ...
                      <p className="text-xl font-bold text-orange-900">{financialForecast.growth_rate}%</p>
                    </div>
